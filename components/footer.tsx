    ...
    <footer className="animate-fade-in bg-gray-900 text-white py-8 sm:py-12 px-2 sm:px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8">
          <div>
            ...
            <p className="text-gray-400 leading-relaxed text-sm sm:text-base">
              Реселлер Mary Kay. Продаем только оригинальную продукцию с гарантией качества.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-1 sm:space-y-2 text-gray-400 text-sm sm:text-base">
              ...
              <p>Оплата: Наложенным платежом при получении</p>
        ...
        <div className="border-t border-gray-800 mt-6 sm:mt-8 pt-6 sm:pt-8 text-center text-gray-400 text-xs sm:text-sm">
          <p>&copy; 2025 Beauty Store. Все права защищены.</p>
