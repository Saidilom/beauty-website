  ...
  return (
    <section id="order" className="animate-fade-in py-10 sm:py-20 px-2 sm:px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-10 sm:mb-16 text-white">
          <Badge className="mb-4 bg-white text-purple-600 px-4 sm:px-6 py-2 text-base sm:text-lg font-semibold">Оформить заказ</Badge>
          <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6">Готовы начать преображение?</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-12">
          {/* Contact Methods */}
          <Card className="p-4 sm:p-8 bg-white/10 backdrop-blur-sm border-white/20">
            <CardContent className="p-0">
              <h3 className="text-lg sm:text-2xl font-bold text-white mb-4 sm:mb-8 text-center">Способы связи</h3>

              <div className="flex items-center justify-center gap-2 sm:gap-4 mb-4 sm:mb-8 text-white">
              ...
              <div className="mt-4 sm:mt-8 p-2 sm:p-4 bg-white/10 rounded-lg text-white text-center">
                <p className="text-xs sm:text-sm opacity-90 mb-1 sm:mb-2">Работаем ежедневно</p>
          ...
          <div className="space-y-4 sm:space-y-6">
            <h3 className="text-lg sm:text-2xl font-bold text-white mb-4 sm:mb-8 text-center">Почему выбирают нас</h3>

            {advantages.map((advantage, index) => (
              <Card key={index} className="p-4 sm:p-6 bg-white/10 backdrop-blur-sm border-white/20">
                <div className="flex items-start gap-2 sm:gap-4">
                  ...
                  <div className="text-white">
                    ...
                    <p className="opacity-90 text-xs sm:text-base">{advantage.description}</p>
                  </div>
                </div>
              </Card>
            ))}

            <Card className="p-4 sm:p-6 bg-white text-center">
        ...
        <div className="mt-8 sm:mt-16 text-center">
          <Card className="p-4 sm:p-8 bg-white/10 backdrop-blur-sm border-white/20 text-white">
            <h3 className="text-lg sm:text-2xl font-bold mb-2 sm:mb-4">Что входит в стоимость:</h3>
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 text-xs sm:text-sm">
